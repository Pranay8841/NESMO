        ...
        <>
            ...
            <section className="bg-white py-8 sm:py-12 md:py-16 lg:py-20">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
                    ...
                    {/* President Message Card */}
                    <div className="bg-gray-50 rounded-lg sm:rounded-lg md:rounded-2xl overflow-hidden shadow-sm">
                        <div className="flex flex-col md:flex-row items-stretch">

                            {/* Leader Image */}
                            <div
                                className="w-full md:w-2/5 min-h-[300px] sm:min-h-[350px] md:min-h-[450px] bg-cover bg-center"
                                style={{ backgroundImage: `url(${leaderImage})` }}
                                aria-label="Dr. Rajesh Sharma"
                            />

                            {/* Message Content */}
                            <div className="flex-1 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-center gap-4 sm:gap-5 md:gap-6">
                                ...
                                <blockquote className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-gray-900 leading-relaxed">
                                ...
                                <div className="mt-2 sm:mt-3 md:mt-4 border-l-4 border-blue-600 pl-3 sm:pl-4">
            ...
            <section className="py-8 sm:py-12 md:py-16 lg:py-20">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8 overflow-x-auto pb-2">
                        <button className="px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 text-white rounded-full text-xs sm:text-sm font-semibold whitespace-nowrap">
                            All Members
                        </button>
                        <button className="px-3 sm:px-5 py-1.5 sm:py-2 bg-white text-gray-600 rounded-full text-xs sm:text-sm font-semibold hover:bg-gray-100 whitespace-nowrap">
                            Executive Committee
                        </button>
                        <button className="px-3 sm:px-5 py-1.5 sm:py-2 bg-white text-gray-600 rounded-full text-xs sm:text-sm font-semibold hover:bg-gray-100 whitespace-nowrap">
                            Advisory Board
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="bg-white rounded-lg sm:rounded-lg md:rounded-xl p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                                {/* Avatar */}
                                <div className="relative w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4">
                                    ...
                                    />
                                    {member.verified && (
                                        <div className="absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-blue-600 rounded-full flex items-center justify-center border-2 border-white">
                                            <CheckCircle2 className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" />
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="text-center mb-3 sm:mb-4">
                                    ...
                                    <p className="text-blue-600 text-xs sm:text-sm font-semibold mb-0.5 sm:mb-1">
                                        {member.role}
                                    </p>
